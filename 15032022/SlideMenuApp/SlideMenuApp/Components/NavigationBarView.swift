...
struct NavigationBarItem: Identifiable {
    ...
    init(iconName: String? = nil, type: NavigationBarType = NavigationBarItemType.none, text: String? = nil) {
    ...
    init(type: NavigationBarType = NavigationBarItemType.none, view: AnyView? = nil) {
        self.type = type
        self.view = view
        self.iconName = nil
        self.text = nil
...
struct NavigationBarItemView: View {
    ...
    init(item: NavigationBarItem, optionSelected: ((NavigationBarType) -> Void)?){
        self.item = item
        self.optionSelected = optionSelected
    }
...
struct NavigationBarView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationBarView(title: "Navigation Bar", subTitle: "Subtitle navigation Bar", optionSelected: nil)
    }
}
